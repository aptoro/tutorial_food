               ...
               <h1 align="center">Aptoro's Food Order & Delivery</h1>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <div class="col-12">
						  <h2 align="center"><span>Thank u for shopping with us</span></h2>
						    <div align="center">
                            <p><font color="gray"><i>Order sent successfully!</i></font></p>
		  <p>Your order no. is <?php echo "<font size='4' color='black'>".$_REQUEST['order_no']."</font>";?></p>
		  <p>Thank you. Please come again.</p>
          <img src="images/thank-you-dinosaur.gif">
                          </div>
		  <br><br>
